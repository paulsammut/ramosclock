...
/* Chip enable pin */
#define CSn_RF   LATAbits.LATA1
#define TRIS_CSn_RF TRISAbits.TRISA1

/*--- I N T E R R U P T S ---------------------- */
#define GD0 PORTCbits.RC0
#define GD2 PORTAbits.RA6
#define TRIS_GD0 TRISCbits.TRISC0
#define TRIS_GD2 TRISAbits.TRISA6
